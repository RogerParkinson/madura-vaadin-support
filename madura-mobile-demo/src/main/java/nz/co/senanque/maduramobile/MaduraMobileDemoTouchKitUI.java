package nz.co.senanque.maduramobile;

import nz.co.senanque.maduramobile.ui.*;
import nz.co.senanque.maduramobile.gwt.client.*;
...
@Widgetset("nz.co.senanque.maduramobile.gwt.MaduraMobileDemoWidgetSet")
@Theme("touchkit")
