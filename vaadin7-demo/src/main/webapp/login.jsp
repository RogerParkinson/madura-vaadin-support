...
<html>
<head>
<title>${labels.getMessage("login.title",null, Locale.getDefault())} - webapp</title>
	...
	<div>
		<form name='loginForm' id='loginf' action='${loginUrl}' method='post'>
			<div>
				...
				<label> 
					<span>${labels.getMessage("login.username",null, Locale.getDefault())}</span><input type="text" name="username" autofocus />
				</label> 
				<label>
