...
public class TreeSpeciesDAO {
	...
	*/
	@Transactional
	public void createTree(TreeSpecies person)
	{
	...
	*/
	...
	public List<TreeSpecies> getAllTrees()
	{
	return entityManager.createQuery("from nz.co.senanque.addressbook.instances.TreeSpecies", TreeSpecies.class).getResultList();
	}
	...
	*/
	@Transactional
	public void deleteTree(TreeSpecies Tree)
	{
